...
The lecture consists of a live demo. To explore the live “slides”, you can run the demo by [downloading Glamorous Toolkit](https://gtoolkit.com/download/) and evaluating the following code in a playground:
